            ...
            @if (Auth::check())
              <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a href="{{ url('/admin/menu') }}" class="dropdown-item" title="Productos"><i class="fa fa-arrow-circle-right"></i>&nbsp;Menu</a>
                  <a href="{{ url('/admin/menu') }}" class="dropdown-item" title="Productos"><i class="fa fa-caret-square-right"></i>&nbsp;Catering</a>                  
